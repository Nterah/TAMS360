-- TAMS360 Database Seed File (FINAL - No Constraint Required)
-- For schema: tams360
-- ID columns use UUID type
...
BEGIN
  ...
  -- Insert template items (only if not already exists)
...
-- (Guardrail, Safety Barrier, Fence, Road Marking, Gantry, Raised Road Marker)
