-- TAMS360 Database Seed File (UUID Version)
-- For schema: tams360
-- ID columns use UUID type (not INTEGER)
...
-- Check templates with component counts
-- SELECT 
--   at.name as asset_type, 
--   ct.name as template_name, 
--   COUNT(cti.item_id) as component_count
-- FROM tams360.asset_component_templates ct
-- JOIN tams360.asset_types at ON ct.asset_type_id = at.asset_type_id
-- LEFT JOIN tams360.asset_component_template_items cti ON ct.template_id = cti.template_id
-- GROUP BY at.name, ct.name
-- ORDER BY at.name;
